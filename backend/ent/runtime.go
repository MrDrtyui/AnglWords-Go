...
func init() {
	...
	_ = wordFields
	// wordDescCreatedAt is the schema descriptor for createdAt field.
	wordDescCreatedAt := wordFields[3].Descriptor()
	// word.DefaultCreatedAt holds the default value on creation for the createdAt field.
	word.DefaultCreatedAt = wordDescCreatedAt.Default.(time.Time)
}
