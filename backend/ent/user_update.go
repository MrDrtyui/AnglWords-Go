...
func (_u *UserUpdate) AddWordIDs(ids ...int) *UserUpdate {
	_u.mutation.AddWordIDs(ids...)
	return _u
}

// AddWords adds the "words" edges to the Word entity.
func (_u *UserUpdate) AddWords(v ...*Word) *UserUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddWordIDs adds the "words" edge to the Word entity by IDs.
func (_u *UserUpdateOne) AddWordIDs(ids ...int) *UserUpdateOne {
	_u.mutation.AddWordIDs(ids...)
	return _u
}

// AddWords adds the "words" edges to the Word entity.
func (_u *UserUpdateOne) AddWords(v ...*Word) *UserUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearWords clears all "words" edges to the Word entity.
func (_u *UserUpdateOne) ClearWords() *UserUpdateOne {
	_u.mutation.ClearWords()
	return _u
}

// RemoveWordIDs removes the "words" edge to Word entities by IDs.
func (_u *UserUpdateOne) RemoveWordIDs(ids ...int) *UserUpdateOne {
	_u.mutation.RemoveWordIDs(ids...)
	return _u
}

// RemoveWords removes "words" edges to Word entities.
func (_u *UserUpdateOne) RemoveWords(v ...*Word) *UserUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
